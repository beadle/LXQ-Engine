...
static_assert(sizeof(Math::Viewport) == sizeof(D3D11_VIEWPORT),
	"Size mismatch");
static_assert(FIELD_OFFSET(Math::Viewport, x) ==
	FIELD_OFFSET(D3D11_VIEWPORT, TopLeftX),
	"Layout mismatch");
static_assert(FIELD_OFFSET(Math::Viewport, y) ==
	FIELD_OFFSET(D3D11_VIEWPORT, TopLeftY),
	"Layout mismatch");
static_assert(FIELD_OFFSET(Math::Viewport, width) ==
	FIELD_OFFSET(D3D11_VIEWPORT, Width),
	"Layout mismatch");
static_assert(FIELD_OFFSET(Math::Viewport, height) ==
	FIELD_OFFSET(D3D11_VIEWPORT, Height),
	"Layout mismatch");
static_assert(FIELD_OFFSET(Math::Viewport, minDepth) ==
	FIELD_OFFSET(D3D11_VIEWPORT, MinDepth),
	"Layout mismatch");
static_assert(FIELD_OFFSET(Math::Viewport, maxDepth) ==
	FIELD_OFFSET(D3D11_VIEWPORT, MaxDepth),
	"Layout mismatch");

RECT
Math::Viewport::ComputeDisplayArea(DXGI_SCALING scaling,
...
RECT
Math::Viewport::ComputeTitleSafeArea(UINT backBufferWidth,
