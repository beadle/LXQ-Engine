...
namespace std {
	...
	template <>
	struct less<Math::Vector2>
	{
		bool operator()(const Math::Vector2& V1,
			const Math::Vector2& V2) const
		{
	...
	template <>
	struct less<Math::Vector3>
	{
		bool operator()(const Math::Vector3& V1,
	...
	template <>
	struct less<Math::Vector4>
	{
		bool operator()(const Math::Vector4& V1,
			const Math::Vector4& V2) const
		{
			return (
	...
	template <>
	struct less<Math::Matrix>
	{
		bool operator()(const Math::Matrix& M1,
			const Math::Matrix& M2) const
		{
			if (M1._11 != M2._11)
	...
	template <>
	struct less<Math::Plane>
	{
		bool operator()(const Math::Plane& P1,
			const Math::Plane& P2) const
		{
			return (
	...
	template <>
	struct less<Math::Quaternion>
	{
		bool operator()(const Math::Quaternion& Q1,
			const Math::Quaternion& Q2) const
		{
			return (
	...
	template <>
	struct less<Math::Color>
	{
		bool operator()(const Math::Color& C1,
			const Math::Color& C2) const
		{
			return (
	...
	template <>
	struct less<Math::Viewport>
	{
		bool operator()(const Math::Viewport& vp1,
			const Math::Viewport& vp2) const
		{
			if (vp1.x != vp2.x)
				return (vp1.x < vp2.x);
			if (vp1.y != vp2.y)
